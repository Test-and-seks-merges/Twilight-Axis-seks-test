...
/datum/patron/divine/noc
	...
	worshippers = "Жрецы Патриархата Двергейла, маги, ученые, писцы, амбициозные личности, исследователи, зибантийцы, люпиане, лунатики."
	confess_lines = list(
		"NOC IS NIGHT!",
		"NOC SEES ALL!",
...
/datum/patron/divine/undivided
	...
	worshippers = "Священнослужители Валорийский конфессии, Рыцари Клятвы, прагматики Церкви Десяти."
