		...
		if(sect)
			...
			if(m)
				if(prob(1) && sect == "sect1")
					...
					user.say("ПСАЙ 66:6... <b><u>Всеотец</u></b> изрёк: «Я прощаю тебя, ибо люблю тебя как отец любит свою дочь». И кровь стекала по лезвию и из груди е- Откуда это здесь?!")
				else
					user.say(m)	
